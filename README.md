<div align="center">
  <img src="docs/assets/readme-hero.png" alt="Shiproof Hero" width="100%">
  
  <p><em>Proof of Ship automator: push code → AI tweets it.</em></p>
  
  [![Live Demo](https://img.shields.io/badge/Live-Demo-brightgreen.svg)](https://sagapad.vercel.app)
  [![Pitch Video](https://img.shields.io/badge/Pitch-Video-red.svg)](https://youtube.com/your-video)
  [![GitHub](https://img.shields.io/badge/GitHub-Repository-black.svg)](https://github.com/edycutjong/frontier-sagapad)
</div>
...
1. **Clone the repo:**
   ```bash
   git clone https://github.com/edycutjong/frontier-sagapad.git
   cd frontier-sagapad
   ```
